						            	...
						            	<ul class="timeline">
								            ...
								            <li>
								              ...
								              <div class="timeline-item">
								                <h3 class="timeline-header no-border">guidelines one</h3>
								              </div>
								            </li>
								            <li>
								              <i class="fa fa-laptop bg-blue"></i>
								              <div class="timeline-item">
								                <h3 class="timeline-header no-border">Applicaiton submitted will appear in group applicaiton list</h3>
								              </div>
								            </li>
								            <li>
								              <i class="fa fa-navicon bg-success"></i>
								              <div class="timeline-item">
								                <h3 class="timeline-header no-border">If you click on application form grop, then this application will be there in your tasklist if you view and dint take further action</h3>
								              </div>
								            </li>
								        </ul>
						            </div>
